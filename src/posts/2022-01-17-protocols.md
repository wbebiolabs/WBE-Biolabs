...
| --- |
|![Alignment of pPICZAwbe and pPICZ A](/assets/images/posts/0A03-pPICZAwbevspPICZA.png "Alignment of pPICZAwbe and pPICZ A")|
...
| --- |
|![Virtual gel electrophoresis of HincII digestion products of pPICZα A and pPICZAwbe](/assets/images/posts/0A04-pPICZAwbe_RE_verification.png "Virtual gel electrophoresis of HincII digestion products of pPICZα A and pPICZAwbe. 100bp NEB ladder is used.")|
...
| --- |
|![PCR product of pPICZAwbe (324 bp) vs pPICZα A (589 bp)](/assets/images/posts/0A04-pPICZAwbe_PCR_verification.png "PCR product of pPICZAwbe (324 bp) vs pPICZα A (589 bp)")|
...
| --- |
|![Map of pPIC9K. The vector contains AOX1 promoter, α-factor signal peptide, and AOX1 terminator flanking a cloning site. The α-factor signal peptide sequence is annotated in light purple.](/assets/images/posts/0B00-pPIC9K.png "Map of pPIC9K")|
...
| --- |
|![Positions of P15-AG-21_pPIC3.5Kwbe-F and P15-AH-21_pPIC3.5Kwbe-R in pPIC9K](/assets/images/posts/0B00-pPIC9K-primers.png "Positions of P15-AG-21_pPIC3.5Kwbe-F and P15-AH-21_pPIC3.5Kwbe-R in pPIC9K")|
...
| --- |
|![linPIC9K-xαFactor = PCR product of pPIC9K lacking α-factor signal sequence (size = 9,019 bp). The product contains BamHI sites at both ends](/assets/images/posts/0B01-pPIC9K-PCRproduct.png "linPIC9K-xαFactor")|
...
| --- |
|![Digestion product of fPIC9K-xαFactor/BamHI](/assets/images/posts/0B02-fPIC9K-xαFactor_BamHI.png "Digestion product of fPIC9K-xαFactor/BamHI")|
...
| --- |
|![Alignment of pPIC3.5Kwbe and the original pPIC3.5K showing identical sequences along the vectors](/assets/images/posts/0B03-pPIC3.5KwbevspPIC3.5K.png "Alignment of pPIC3.5Kwbe and the original pPIC3.5K")|
...
| --- |
|![Virtual gel electrophoresis of HincII digestion products of pPIC9K and pPIC3.5Kwbe. A 1kb NEB ladder is used](/assets/images/posts/0B04-pPIC3.5Kwbe_RE_verification.png "Virtual gel electrophoresis of HincII digestion products of pPIC9K and pPIC3.5Kwbe")|
...
| --- |
|![PCR product of pPIC3.5Kwbe (221 bp) vs pPIC9K (493 bp)](/assets/images/posts/0B04-pPIC3.5Kwbe_PCR_verification.png "PCR product of pPIC3.5Kwbe (221 bp) vs pPIC9K (493 bp)")|
